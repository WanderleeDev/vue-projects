...
/**
  ...
  *
  * @checksum - 164ad827fb1c1ed73e73efeacef8ee61624b8e78d23dbd6e1711daefe8f06319
  * @variables - radius=rounded-lg,accentColor=indigo,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
